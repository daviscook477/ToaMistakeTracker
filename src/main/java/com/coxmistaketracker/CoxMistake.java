...
public enum CoxMistake {
    ...
    SHAMANS_SPAWN_EXPLOSION("Shamans Spawn Explosion", CoxMistakeTrackerConfig::shamansSpawnMessage, "I'm exploding!", "shamans-spawn.png"),
    TEKTON_SPARKS("Tekton Sparks", CoxMistakeTrackerConfig::tektonSparksMessage, "I'm feeling sparky!", "death.png"),
    TEKTON_MELEE("Tekton Melee Hit", CoxMistakeTrackerConfig::tektonMeleeMesssage, "I'm getting hammered!", "tekton-melee.png"),
    ...
    SMALL_MUTTADILE_HEAL("Small Muttadile Heal", CoxMistakeTrackerConfig::muttadilesHealMessage, "Meat! Yum!", "muttadiles-heal.png", ImmutableSet.of(7562)),
    BIG_MUTTADILE_HEAL("Big Muttadile Heal", CoxMistakeTrackerConfig::muttadilesHealMessage, "Meat! Yum!", "muttadiles-heal.png", ImmutableSet.of(7563)),
    ...
    VESPULA_LUX_GRUB_HATCHED("Vespula Lux Grub Hatched", CoxMistakeTrackerConfig::vespulaLuxGrubHatchedMessage, "Rise my soldier!", "lux-grub-hatched.png", ImmutableSet.of(7530, 7531, 7532)),
    VESPULA_LUX_GRUB_HIT("Vespula Lux Grub Hit", CoxMistakeTrackerConfig::vespulaLuxGrubHitMessage, "Go my spawn!", "lux-grub-hit.png", ImmutableSet.of(7530, 7531, 7532)),
    OLM_ACID_STANDSTILL("Olm Acid Standstill", (config -> ""), "", "olm-acid.png"),
    OLM_FALLING_CRYSTALS("Olm Falling Crystals", CoxMistakeTrackerConfig::olmFallingCrystalsMessage, defaultFallingCrystalMessage(), "falling-crystals.png"),
    OLM_FALLING_CRYSTAL_ATTACK("Olm Falling Crystal Attack", CoxMistakeTrackerConfig::olmFallingCrystalAttackMessage, defaultFallingCrystalMessage(), "falling-crystals-attack.png"),
    OLM_CENTER("Olm Head Centered", CoxMistakeTrackerConfig::olmCenterMessage, "What do I see here?", "olm-center.png", ImmutableSet.of(7551, 7554)),
    OLM_PRAYER_ORB("Olm Prayer Orb", CoxMistakeTrackerConfig::olmPrayerMessage, "What even was that attack?", "prayer-orb.png"),
    OLM_SPECIAL_CRYSTAL_OCCURS("Olm Crystals Special Occurs", CoxMistakeTrackerConfig::olmSpecialOccursMessage, defaultSpecialOccursMessage(), "crystals.png", ImmutableSet.of(7551, 7554)),
    OLM_SPECIAL_LIGHTNING_OCCURS("Olm Lightning Special Occurs", CoxMistakeTrackerConfig::olmSpecialOccursMessage, defaultSpecialOccursMessage(), "lightning.png", ImmutableSet.of(7551, 7554)),
    OLM_SPECIAL_TELEPORTS_OCCURS("Olm Teleports Special Occurs", CoxMistakeTrackerConfig::olmSpecialOccursMessage, defaultSpecialOccursMessage(), "teleports.png", ImmutableSet.of(7551, 7554)),
    OLM_SPECIAL_CRYSTALS_DAMAGE("Olm Crystals Special Damage", CoxMistakeTrackerConfig::olmCrystalsMessage, "I'm bursting!", "crystals.png"),
    OLM_SPECIAL_LIGHTNING_DAMAGE("Olm Lightning Special Damage", CoxMistakeTrackerConfig::olmLightningMessage, "I'm shocked!", "lightning.png"),
    OLM_SPECIAL_TELEPORTS_DAMAGE("Olm Teleports Special Damage", CoxMistakeTrackerConfig::olmTeleportsMessage, "I'm going on a trip!", "teleports.png"),
    ...
    OLM_FLAME_WALL_DAMAGE("Olm Flame Wall Damage", CoxMistakeTrackerConfig::olmFlameWallMessage, "I'm burning up!", "flame-wall.png"),
    OLM_AUTO("Olm Auto Incorrect Overhead", (config -> ""), "", "olm-auto.png"),
