...
public class DelayedMistakeTracker {
     ...
     */
    public void addDelayedMistake(@NonNull String raiderName, @NonNull CoxMistake mistake, @NonNull Integer currentTick,
                                  Integer tickDelay) {
     ...
     */
    public List<CoxMistake> popDelayedMistakes(@NonNull String raiderName, @NonNull Integer currentTick) {
     ...
     */
    public List<CoxMistake> popAllDelayedMistakes(@NonNull String raiderName) {
        if (delayedMistakes.get(raiderName) == null) return Collections.emptyList();

        List<CoxMistake> mistakes = delayedMistakes.get(raiderName).stream()
