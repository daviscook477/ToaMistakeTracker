...
public class OverheadTracker extends DelayedObjectsTracker<Projectile> {
    ...
    public boolean didMissPrayer(Raider raider) {
        ...
        log.info("playerHeadIcon " + playerHeadIcon.name() + " but required " + requiredHeadIcon.name() + " for projectile " + activeProjectile.getId() + " w/ remaining " + activeProjectile.getRemainingCycles() + " cycles");
